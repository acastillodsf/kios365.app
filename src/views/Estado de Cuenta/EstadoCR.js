...
const EstadoCR = ({ match }) => {
  ...
  const getEstadoAh = (cuenta) => {
    ...
    clienteAxios.get(`/Consulta/certificado`,{params:{cuenta}})
    .then(({data})=>{
      console.log(data)
                  ...
                  <CFormGroup row className="my-0">
                    ...
                    <CCol xs="5">
                      ...
                      <CFormGroup row>
                        ...
                        <CCol xs="12" md="7">
                          <CInput value={estado.tasa_interes} className="textend" />
                        </CCol>
                      </CFormGroup>
                      ...
                      <CTabPane>
                        <CDataTable
                          ...
                          scopedSlots={{
                            ...
                            interes: (item) => RFormat(item.interes),
