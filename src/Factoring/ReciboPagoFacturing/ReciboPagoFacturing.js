...
export const ReciboPagoFacturing = ({ match }) => {
  ...
  const SalvarFactura = async () => {
    swal({
      ...
      if (respuesta) {
        clienteAxios
          .post("/facturas/facturing/saving", DataForm)
          .then(({ data }) => {
    ...
    <div>
      ...
      <CRow>
        ...
        >
          ...
          />
          <h2>Recibo de Pago Facturing.</h2>
        </CCol>
      ...
      <CRow style={{ marginTop: 20, marginBottom: 30 }}>
       ...
       <RegistroSearch
        tipomovi={2001}
        title="Recibos de Pagos Facturing"
        active={searchActive}
...
export default ReciboPagoFacturing;
